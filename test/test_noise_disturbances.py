...
from commonroad_control.cr_control_easy_api.mpc_for_dedicated_planner import mpc_for_reactive_planner, \
    mpc_for_reactive_planner_no_uncertainty
...
class TestNoiseDisturbance(unittest.TestCase):
    ...
    def test_no_uncertainty(self) -> None:
        ...
        Test no uncertainty
        """
        scenario_name_xml = "ITA_Foggia-6_1_T-1.xml"
        ...
        with self.subTest(msg=f"testing no uncertainty scenario {scenario_name}"):
            ...
            noisy_traj, disturbed_traj, input_traj = mpc_for_reactive_planner_no_uncertainty(
                scenario=scenario,
                planning_problem=planning_problem,
                reactive_planner_state_trajectory=rp_states,
                reactive_planner_input_trajectory=rp_inputs,
