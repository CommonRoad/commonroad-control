...
from commonroad_control.optimal_control.ocp_dataclasses import State, ControlInput
...
class ImplementedModels(enum.Enum):
    ConstrainedIntegrator = "ConstrainedIntegrator"
...
def get_params() -> Dict:
    ...
    params["lbx"] = StateConstrainedIntegrator(
        position_x=-inf,
        position_y=-inf,
        orientation=-inf,
        velocity_x=0.0,
        velocity_y=-6.0,
        velocity_orientation=-pi,
    )
    params["ubx"] = StateConstrainedIntegrator(
        position_x=inf,
        position_y=inf,
        orientation=inf,
        velocity_x=25.0,
    ...
    params["lbu"] = ControlInputConstrainedIntegrator(
        acceleration_x=-9.0, acceleration_y=-12, acceleration_orientation=-12
    )
    params["ubu"] = ControlInputConstrainedIntegrator(
        acceleration_x=4.0, acceleration_y=12, acceleration_orientation=12
    )
    ...
    params["x0"] = StateConstrainedIntegrator(
...
def dynamics(
    x: Union[cas.SX.sym, np.array], u: Union[cas.SX.sym, np.array]
) -> cas.SX.sym:
    """
...
def ineq_con_stage(
    x: Union[np.array, cas.SX.sym], u: Union[np.array, cas.SX.sym]
) -> List:
    """
...
def init_models(
    model: str,
) -> Union[StateConstrainedIntegrator, ControlInputConstrainedIntegrator]:
    """
    Inits Model
    :param model: model to initialize
    :return: initialized model
    """
    if model == "StateConstrainedIntegrator":
        retval = StateConstrainedIntegrator()
    elif model == "ControlInputConstrainedIntegrator":
        retval = ControlInputConstrainedIntegrator()
