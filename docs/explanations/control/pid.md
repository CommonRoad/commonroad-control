...
Based on the PID controller, a controller for decoupled longitudinal and lateral motion control ([`PIDLongLat`](../../core_api/control/pid.md)) is presented afterwards.
...
The [`PIDControl`](../../core_api/control/pid.md) class implements the [`ControllerInterface`](../../core_api/control/controller_interface.md).
...
The [`PIDLongLat`](../../core_api/control/pid.md) controller combines two PID controllers for longitudinal and lateral control, i.e., the coupling between
...
The [`PIDLongLat`](../../core_api/control/pid.md) class implements the [`ControllerInterface`](../../core_api/control/controller_interface.md).
